...
interface BranchTreeNode extends Branch {
...
/**
 * Renders a branch tree node and its children recursively
 */
 ...
 */
function buildBranchTree(branches: Branch[]): BranchTreeNode | null {
  const map: Record<string, BranchTreeNode> = {};
